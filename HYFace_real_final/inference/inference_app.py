...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_vocal_path', type=str, default="inference/result/our_hyface_vocal", help='your-target-output-root')
